...
//   invoke properties Related with the constructor function
// 2. What is "this" when joe.scopeArrow() is invoked?
//    invoke from DOM document for window
// 3. Explain why "this" is different when an arrow function is used.
//(this) is used in arrow Fun is fetched lexically from the scope it sits inside.it has no (this) 
//so when i used (this) i am talking to the outer scope
